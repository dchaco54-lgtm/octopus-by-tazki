...
import { type SavedFavoriteView, type SubscriptionViewConfig } from "@/modules/subscriptions/list-view/types";

interface SavedViewsMenuProps {
  favorites: SavedFavoriteView[];
  defaultView: SubscriptionViewConfig;
  currentView: SubscriptionViewConfig;
  onApplyView: (config: SubscriptionViewConfig) => void;
  onSaveCurrent: () => void;
      ...
      {({ close }) => (
        <div className="space-y-3">
          <div>
            ...
            <p className="mt-1 text-xs text-[var(--tazki-slate-500)]">Guarda combinaciones de columnas, anchos y filtros.</p>
          </div>
